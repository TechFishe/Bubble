...
<template>
  <main class="flex flex-col">
    <section class="flex h-fullscreen w-screen flex-col items-center justify-center">
      <h1 class="border-b-[3px] border-b-snow/15 bg-gradient-to-r from-snow to-aero-100 to-65% bg-clip-text px-4 font-mono text-8xl font-black uppercase text-transparent">Welcome</h1>
