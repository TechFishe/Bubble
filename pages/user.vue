...
<template>
  <div class="flex h-fullscreen">
    <main>
      <section class="flex h-24 w-screen items-center">
        ...
        <div class="flex items-center space-x-3">
          <button @click="logout" class="transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
          ...
          <button class="transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-10 w-10">
              <path
