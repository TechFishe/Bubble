  ...
  <div id="screen" class="min-h-screen overflow-x-hidden bg-shark-950 text-snow">
    <header id="top" class="flex h-24 w-screen border-b-2 border-b-snow/45 bg-shark-950 px-8">
      ...
      <nav class="flex w-full items-center justify-end">
        <NuxtLink to="/" class="mr-1.5 transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
        ...
        <div class="h-6 w-0 border border-snow/15"></div>
        <NuxtLink to="/chat" class="mx-1.5 transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="h-10 w-10">
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
          </svg>
        </NuxtLink>
        <div class="h-6 w-0 border border-snow/15"></div>
        <!-- <button class="hover:text-aero-100 mx-1.5 hover:drop-shadow-navBtn transition-all duration-200 ease-out">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
            </svg>
          </button>
          <div class="h-6 w-0 border border-snow/15"></div> -->
        <NuxtLink v-if="!loggedIn" to="/user" class="ml-1.5 transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-10 w-10">
    ...
    <slot />
    <footer class="flex min-h-24 w-screen border-t-2 border-snow/45 bg-shark-950 px-4">
      <div class="flex flex-grow"></div>
      <a href="#top" class="ml-1.5 self-center transition-all duration-200 ease-out hover:text-aero-100 hover:drop-shadow-navBtn">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-10 w-10">
