		...
		{#if canPlay}
			<section class="grid max-w-fit grid-cols-2 grid-rows-1 divide-x-[1.5px] divide-slate-700 text-green-400">
				<h1
					...
					class="ml-1 flex max-w-fit items-center pr-1.5 text-5xl font-black"
					>Bubble
				</h1>
				<div class="flex max-w-fit pl-1.5">
					<svg
						...
						<g
							...
							<path
								d="M1649 1231 c-20 -20 -29 -39 -29 -61 0 -43 47 -90 90 -90 43 0 90 47 90 90 0 22 -9 41 -29 61 -40 39 -82 39 -122 0z" />
						</g>
					</svg>
					{#if fishTalk}
						<svg
							...
							stroke-width="1.5"
							stroke="currentColor"
							class="relative right-1.5 h-7 w-7">
							<path
