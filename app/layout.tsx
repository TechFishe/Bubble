...
export const metadata: Metadata = {
  title: 'Bubble',
  description: 'An open-sourse social media app!',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-slate-900 text-slate-50 overflow-hidden">
    	<header className="z-40 grid h-16 w-screen grid-flow-col items-center rounded-b-lg bg-slate-800/95 px-3 py-1 backdrop-blur-[2px]">
    			<section className="grid max-w-fit grid-cols-2 grid-rows-1 divide-x-[1.5px] divide-slate-700 text-green-400">
    				...
    				<div className="flex max-w-fit pl-1.5">
    					...
    					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="relative right-1.5 h-7 w-7">
    						<path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
    					</svg>
    				</div>
    			</section>
    			<nav className="grid max-w-fit grid-flow-col grid-rows-1 items-center divide-x-[1px] divide-slate-700 justify-self-end">
      ...
      {children}
    	<section className="absolute bottom-0 flex w-screen h-16 justify-center">
    		<footer className="mt-5 inline-block w-[97.5%] divide-x-[1px] border-t-2 border-slate-700 py-2.5 px-5">
...
const NavBtn:FC <NavProps> = (props) =>{
  return(
    <Link href={props.URL} className="flex px-5">
	  	<button className="group rounded-full p-1.5 shadow-sm transition-all duration-150 ease-in hover:scale-[1.075] hover:bg-zinc-700 hover:shadow-md hover:shadow-green-400/25">
	  		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="transition-color h-8 w-8 delay-75 duration-150 ease-in group-hover:text-green-400">
